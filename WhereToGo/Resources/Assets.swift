...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let textBlack65 = ColorAsset(name: "textBlack65")
    internal static let textBlack85 = ColorAsset(name: "textBlack85")
    internal static let textRed = ColorAsset(name: "textRed")
    internal static let popRed = ColorAsset(name: "popRed")
    internal static let tableView = ColorAsset(name: "tableView")
  }
}
